...
Usage
-----
  uv run python experiments/neurips/plot_results.py
...
def fig05():
    ...
    ax.set_title("Transfer Accuracy (all ~55%) < Cross-Family (64.6%)")
    ...
    ax.text(N - 0.45, -0.7, "Cross-family reference: 64.6%",
...
def fig14():
    ...
    rows = [
        ...
        ["Cross-model xfer",   "64.6%",      "—",      "56.4%",    "56.4%",       "NO",   "—"],
        ["Causal steering",    "+1.9pp",     "OK",     "OK",       "OK",          "NO",   "+direct"],
        ["MSE (lower better)", "0.102",      "0.175",  "0.187",    "0.116",       "0.312","N/A"],
